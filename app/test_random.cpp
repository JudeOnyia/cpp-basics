...
int main(){
	...
	ra::random::linear_congruential_generator obj_mine((unsigned long long int)14,(unsigned long long int)5,(unsigned long long int)29);
	...
	cout << "mylcg's min value: " << obj_mine.mine() << endl;
